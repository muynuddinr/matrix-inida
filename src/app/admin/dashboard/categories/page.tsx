            ...
            <div className="bg-white border border-gray-200 rounded-xl p-6 sticky top-6 shadow-lg">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-4 space-y-2 border-t border-gray-200">
                  ...
                  <button className="w-full flex items-center justify-center py-2 px-4 bg-red-500/20 hover:bg-red-500/30 text-red-400 rounded-lg transition font-semibold text-sm">
